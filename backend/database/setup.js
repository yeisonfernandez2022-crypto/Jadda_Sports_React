/*
 * setup.js â€” InicializaciÃ³n automÃ¡tica de la base de datos.
 ...
 * estÃ© lista en el arranque de Docker (hasta 10 intentos).
 */
...
// ConfiguraciÃ³n separada del pool de db.js â€” esta conexiÃ³n es solo para setup
const DB_CONFIG = {
  host: process.env.DB_HOST || 'database',
  user: process.env.DB_USER || 'root',
  password: process.env.DB_PASSWORD || 'tu_password_secreto',
  database: process.env.DB_NAME || 'jadda_sports_db',
  multipleStatements: true,  // Necesario para ejecutar mÃºltiples CREATE/INSERT en una sola llamada
};
...
-- -------------------------------------------------------------------------
-- PROVEEDORES, CATEGORÃAS, DESCUENTOS Y PRODUCTOS
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- VARIANTES, IMÃGENES Y CARACTERÃSTICAS DE PRODUCTOS
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- INVENTARIO, EMPLEADOS Y MÃ‰TODOS DE PAGO
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- VENTAS, DETALLE, ENVÃOS Y MOVIMIENTOS DE STOCK
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- FAVORITOS, HISTORIAL, CARRITO Y RESEÃ‘AS
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- PQR, SESIONES, RETOS, PLANES DE ENTRENAMIENTO Y MÃ‰TODOS DE PAGO POR USUARIO
-- -------------------------------------------------------------------------
...
// INSERT IGNORE evita duplicados si el setup se ejecuta mÃºltiples veces.
// =========================================================================
...
(1, 'Nike Colombia SAS', '3101112233', 'ventas@nike.com', 'BogotÃ¡ D.C.', 'Carlos PÃ©rez', '900123001'),
(2, 'Adidas Colombia Ltda', '3102223344', 'contacto@adidas.com', 'MedellÃ­n', 'Laura MÃ©ndez', '900123002'),
(3, 'Puma Sports SAS', '3103334455', 'info@puma.com', 'Cali', 'AndrÃ©s Gil', '900123003'),
(4, 'Reebok Latam SAS', '3104445566', 'ventas@reebok.com', 'Barranquilla', 'SofÃ­a RamÃ­rez', '900123004'),
(5, 'BodyFit Equipos SAS', '3105556677', 'contacto@bodyfit.com', 'BogotÃ¡ D.C.', 'Miguel Castro', '900123005'),
(6, 'Spalding Colombia', '3106667788', 'ventas@spalding.com', 'Cartagena', 'Daniel Ortiz', '900123006'),
(7, 'Everlast Colombia', '3107778899', 'info@everlast.com', 'Bucaramanga', 'MarÃ­a Torres', '900123007'),
(8, 'ProFit Machines SAS', '3111112233', 'contacto@profit.com', 'BogotÃ¡ D.C.', 'Fernando RÃ­os', '900123008'),
(9, 'Under Armour SAS', '3112223344', 'ventas@underarmour.com', 'Cali', 'Camila Soto', '900123009'),
(10, 'New Balance Colombia', '3113334455', 'info@newbalance.com', 'MedellÃ­n', 'Ricardo LeÃ³n', '900123010'),
(11, 'Wilson Sports SAS', '3114445566', 'ventas@wilson.com', 'BogotÃ¡ D.C.', 'Natalia PeÃ±a', '900123011'),
(12, 'Asics Colombia SAS', '3115556677', 'contacto@asics.com', 'Pereira', 'Javier Mora', '900123012'),
(13, 'Kappa Sports SAS', '3116667788', 'info@kappa.com', 'BogotÃ¡ D.C.', 'Valentina Ruiz', '900123013'),
(14, 'Umbro Colombia', '3117778899', 'ventas@umbro.com', 'Cali', 'SebastiÃ¡n DÃ­az', '900123014'),
(15, 'Decathlon Proveedores SAS', '3121112233', 'contacto@decathlon.com', 'BogotÃ¡ D.C.', 'Paola Vega', '900123015');

-- -------------------------------------------------------------------------
-- CATEGORÃAS: 15 categorÃ­as (FÃºtbol, Baloncesto, Running, ...)
-- -------------------------------------------------------------------------
INSERT IGNORE INTO CATEGORIAS (ID_CATEGORIA, NOMBRE_CATEGORIA, DESCRIPCION) VALUES
(1, 'FÃºtbol', 'Balones, guantes, espinilleras y todo lo que necesitas para dominar la cancha'),
(2, 'Baloncesto', 'Balones, aros y accesorios para llevar tu juego a otro nivel dentro y fuera de la cancha'),
(3, 'Running', 'Tenis, ropa y accesorios ligeros diseÃ±ados para acompaÃ±arte en cada kilÃ³metro'),
(4, 'Gimnasio', 'Pesas, mancuernas y accesorios de fuerza para potenciar tus entrenamientos'),
(5, 'NataciÃ³n', 'Gafas, gorros y trajes de baÃ±o de alto rendimiento para entrenar en el agua'),
(6, 'Ciclismo', 'Guantes, cascos y ropa tÃ©cnica para rodar con comodidad y seguridad'),
(7, 'Deportes extremos', 'Equipos especializados para skate, escalada y aventura con mÃ¡xima resistencia'),
(8, 'Ropa deportiva', 'Camisetas, buzos y leggings cÃ³modos y transpirables para cualquier actividad'),
(9, 'Accesorios', 'Morrales, botellas, muÃ±equeras y complementos que no pueden faltar'),
(10, 'ProtecciÃ³n', 'Caneleteras, coderas y elementos de seguridad para entrenar sin preocupaciones'),
(11, 'Cardio', 'ElÃ­pticas, caminadoras y bicicletas para mejorar tu resistencia desde casa o el gym'),
(12, 'Hogar fitness', 'MÃ¡quinas y equipos compactos para armar tu gimnasio ideal en casa'),
(13, 'Suplementos', 'ProteÃ­nas, vitaminas y nutriciÃ³n deportiva para alcanzar tus metas'),
(14, 'TecnologÃ­a deportiva', 'Relojes GPS, pulseras y gadgets para medir tu rendimiento al detalle'),
(15, 'Ofertas', 'Los mejores descuentos del momento en artÃ­culos deportivos seleccionados');

-- -------------------------------------------------------------------------
-- DESCUENTOS: 2 descuentos de ejemplo (temporada + cupÃ³n JADDA10)
-- -------------------------------------------------------------------------
INSERT IGNORE INTO DESCUENTOS (ID_DESCUENTO, DESCRIPCION, PORCENTAJE, FECHA_INICIO, FECHA_FIN) VALUES
(1, 'Descuento temporada fÃºtbol', 10, '2025-06-01', '2025-07-01'),
(2, 'JADDA10', 10, '2025-01-01', '2026-12-31');

-- -------------------------------------------------------------------------
-- PRODUCTOS: 45 productos de ejemplo en todas las categorÃ­as
-- -------------------------------------------------------------------------
INSERT IGNORE INTO PRODUCTOS (ID, NOMBRE, MARCA, PRECIO, DESCRIPCION, ID_PROVEEDOR, ID_CATEGORIA, ID_DESCUENTO) VALUES
(1, 'Guayos profesionales', 'Adidas', 220000, 'Guayos para cÃ©sped natural', 1, 1, NULL),
(2, 'BalÃ³n Al Rihla Pro', 'Adidas', 320000, 'BalÃ³n oficial', 2, 1, NULL),
(3, 'Espinilleras', 'Nike', 70000, 'ProtecciÃ³n fÃºtbol', 1, 1, NULL),
(4, 'Guantes de Portero Future', 'Puma', 240000, 'LÃ¡tex de alto agarre', 1, 1, NULL),
(5, 'Camiseta SelecciÃ³n', 'Adidas', 150000, 'EdiciÃ³n especial', 1, 1, NULL),
(6, 'BalÃ³n baloncesto', 'Spalding', 110000, 'BalÃ³n oficial NBA', 2, 2, NULL),
(7, 'Tenis Lebron Witness', 'Nike', 480000, 'AmortiguaciÃ³n reactiva', 1, 2, NULL),
(8, 'Malla porta balones', 'Spalding', 30000, 'Capacidad 10 balones', 2, 2, NULL),
(9, 'Sudadera deportiva', 'Nike', 120000, 'Sudadera tÃ©rmica', 1, 3, NULL),
(10, 'Zapatillas Ultraboost Light', 'Adidas', 650000, 'Retorno de energÃ­a ligero', 2, 3, NULL),
...
(17, 'Gafas de NataciÃ³n Pro', 'Speedo', 95000, 'AntiempaÃ±ante y UV', 2, 5, NULL),
(18, 'Gorro de NataciÃ³n Silicona', 'Speedo', 25000, 'Ajuste hidrodinÃ¡mico', 1, 5, NULL),
(19, 'Casco Ciclismo Ruta', 'Bell', 250000, 'CertificaciÃ³n seguridad', 2, 6, NULL),
(20, 'Guantes Ciclismo Gel', 'Giant', 85000, 'Acolchado anti-vibraciÃ³n', 1, 6, NULL),
...
(23, 'Chaqueta Rompevientos', 'Adidas', 210000, 'ProtecciÃ³n contra viento', 2, 8, NULL),
(24, 'Leggings Lux High-Rise', 'Reebok', 140000, 'Tela absorciÃ³n humedad', 1, 8, NULL),
(25, 'Termo deportivo', 'Nike', 45000, 'Acero inoxidable', 2, 9, NULL),
(26, 'Gorra deportiva', 'Puma', 40000, 'Ajustable', 2, 9, NULL),
(27, 'Protector bucal', 'Everlast', 25000, 'ProtecciÃ³n dental', 1, 10, NULL),
(28, 'Rodilleras', 'Reebok', 60000, 'Soporte deportivo', 1, 10, NULL),
(29, 'ElÃ­ptica domÃ©stica', 'ProFit', 1800000, 'Equipo cardio', 1, 11, NULL),
(30, 'Reloj Inteligente Sport', 'Garmin', 1200000, 'Monitoreo ritmo cardÃ­aco', 2, 11, NULL),
(31, 'Steps AerÃ³bicos', 'ProFit', 160000, 'Altura ajustable 3 niveles', 1, 12, NULL),
(32, 'Rueda Abdominal Dual', 'BodyFit', 42000, 'Core reforzado', 2, 12, NULL),
(33, 'ProteÃ­na Whey 2lb', 'Optimum', 190000, 'ProteÃ­na de suero pura', 1, 13, NULL),
...
(36, 'Toalla Microfibra', 'Jadda', 35000, 'Secado rÃ¡pido', 1, 15, NULL),
(37, 'Kit Boxeo IniciaciÃ³n', 'Everlast', 350000, 'Pack completo', 1, 15, NULL),
(38, 'BalÃ³n medicinal 5kg', 'Everlast', 120000, 'Entrenamiento funcional', 1, 4, NULL),
(39, 'Camiseta Entrenamiento', 'Nike', 115000, 'Dri-FIT', 1, 8, NULL),
(40, 'Shorts Tennis', 'Adidas', 95000, 'Movilidad lateral', 2, 3, NULL),
(41, 'Polo Tennis', 'Fila', 110000, 'ProtecciÃ³n UV', 2, 3, NULL),
(42, 'Guantes Gimnasio', 'Everlast', 45000, 'VentilaciÃ³n', 1, 4, NULL),
(43, 'Bolsa HidrataciÃ³n 2L', 'Salomon', 125000, 'Compatible running', 2, 3, NULL),
(44, 'MuÃ±equeras', 'Reebok', 25000, 'AlgodÃ³n', 1, 10, NULL),

-- -------------------------------------------------------------------------
-- PRODUCTOS NUEVOS: 60 productos adicionales (IDs 45-104)
-- -------------------------------------------------------------------------
INSERT IGNORE INTO PRODUCTOS (ID, NOMBRE, MARCA, PRECIO, DESCRIPCION, ID_PROVEEDOR, ID_CATEGORIA, ID_DESCUENTO) VALUES
(45, 'BalÃ³n de FÃºtbol Training', 'Adidas', 135000, 'BalÃ³n resistente para entrenamientos', 1, 1, NULL),
(46, 'BalÃ³n de FÃºtbol Premier', 'Nike', 180000, 'BalÃ³n de fÃºtbol para competiciÃ³n', 2, 1, NULL),
(47, 'Guayos Predator Accuracy', 'Adidas', 420000, 'Guayos profesionales para cÃ©sped natural', 1, 1, NULL),
...
(50, 'Medias Antideslizantes FÃºtbol', 'Adidas', 55000, 'Medias deportivas con zonas de agarre', 2, 1, NULL),
(51, 'BalÃ³n Baloncesto Street', 'Spalding', 95000, 'BalÃ³n resistente para exteriores', 2, 2, NULL),
(52, 'BalÃ³n Baloncesto Indoor', 'Nike', 145000, 'BalÃ³n para cancha cubierta', 1, 2, NULL),
(53, 'Aro de Baloncesto PortÃ¡til', 'Spalding', 650000, 'Aro ajustable para entrenamiento', 2, 2, NULL),
(54, 'MuÃ±equeras Baloncesto', 'Nike', 45000, 'MuÃ±equeras absorbentes para jugadores', 1, 2, NULL),
...
(57, 'Tenis Running Floatride', 'Reebok', 390000, 'AmortiguaciÃ³n para largas distancias', 1, 3, NULL),
...
(60, 'Medias Running Compression', 'Adidas', 65000, 'Medias deportivas de compresiÃ³n', 2, 3, NULL),
...
(63, 'Banda ElÃ¡stica Resistencia', 'Everlast', 45000, 'Banda para entrenamiento muscular', 1, 4, NULL),
(64, 'Set Bandas ElÃ¡sticas', 'BodyFit', 90000, 'Set de cinco bandas de resistencia', 2, 4, NULL),
(65, 'Barra OlÃ­mpica', 'BodyFit', 450000, 'Barra para levantamiento de pesas', 1, 4, NULL),
(66, 'Discos OlÃ­mpicos 10kg', 'BodyFit', 180000, 'Disco de peso para entrenamiento', 2, 4, NULL),
(67, 'Aletas NataciÃ³n Training', 'Speedo', 115000, 'Aletas para entrenamiento acuÃ¡tico', 2, 5, NULL),
(68, 'Tabla NataciÃ³n Kickboard', 'Speedo', 75000, 'Tabla para ejercicios de piernas', 1, 5, NULL),
(69, 'Pull Buoy NataciÃ³n', 'Speedo', 65000, 'Accesorio para entrenamiento de brazos', 2, 5, NULL),
(70, 'Traje de NataciÃ³n Deportivo', 'Speedo', 220000, 'Traje de baÃ±o para entrenamiento', 1, 5, NULL),
(71, 'Casco Ciclismo Urbano', 'Bell', 190000, 'Casco ligero para ciclismo urbano', 2, 6, NULL),
(72, 'Casco Ciclismo MontaÃ±a', 'Giant', 280000, 'Casco para ciclismo de montaÃ±a', 1, 6, NULL),
...
(75, 'ArnÃ©s Escalada Deportivo', 'Petzl', 380000, 'ArnÃ©s ajustable para escalada', 2, 7, NULL),
(76, 'MosquetÃ³n Seguridad', 'Black Diamond', 120000, 'MosquetÃ³n de alta resistencia', 1, 7, NULL),
...
(79, 'PantalÃ³n Deportivo', 'Adidas', 160000, 'PantalÃ³n cÃ³modo para entrenamiento', 1, 8, NULL),
(80, 'Camiseta CompresiÃ³n', 'Nike', 135000, 'Camiseta ajustada de compresiÃ³n', 2, 8, NULL),
...
(85, 'Canguro Deportivo', 'Puma', 75000, 'RiÃ±onera para actividades deportivas', 1, 9, NULL),
...
(88, 'Codo Deportivo', 'Everlast', 60000, 'ProtecciÃ³n y soporte para codo', 2, 10, NULL),
(89, 'Faja Deportiva', 'Reebok', 95000, 'Soporte lumbar para entrenamiento', 1, 10, NULL),
(90, 'Vendaje Deportivo', 'Everlast', 30000, 'Vendaje elÃ¡stico para entrenamiento', 2, 10, NULL),
(91, 'Bicicleta EstÃ¡tica', 'ProFit', 1250000, 'Bicicleta para entrenamiento cardiovascular', 1, 11, NULL),
(92, 'Caminadora ElÃ©ctrica', 'ProFit', 2800000, 'Caminadora para entrenamiento en casa', 2, 11, NULL),
(93, 'Bicicleta Spinning', 'ProFit', 1750000, 'Bicicleta profesional de spinning', 1, 11, NULL),
(94, 'Step AerÃ³bico Profesional', 'ProFit', 210000, 'Step ajustable para entrenamiento', 2, 12, NULL),
(95, 'BalÃ³n Bosu', 'BodyFit', 320000, 'Plataforma para equilibrio y estabilidad', 1, 12, NULL),
...
(98, 'ProteÃ­na Whey 5lb', 'Optimum', 360000, 'ProteÃ­na de suero para recuperaciÃ³n muscular', 1, 13, NULL),
(99, 'BCAA 300g', 'Muscletech', 125000, 'Suplemento para recuperaciÃ³n deportiva', 2, 13, NULL),
(100, 'Pre Entreno 300g', 'Muscletech', 145000, 'Suplemento para energÃ­a durante el entrenamiento', 1, 13, NULL),
...
(104, 'Cuerda de Boxeo Profesional', 'Everlast', 55000, 'Cuerda rÃ¡pida para entrenamiento de boxeo', 2, 15, NULL);

-- -------------------------------------------------------------------------
-- VARIANTES: colores + tallas/tamaÃ±os con stock individual
-- -------------------------------------------------------------------------
...
(2,'Blanco/Multicolor','TamaÃ±o','Talla 5',20),
...
(13,'Negro','TamaÃ±o','Ãšnica',100),

(14,'Gris','Peso','5kg',60),

(15,'Negro','Peso','20kg',20),

(16,'Morado','TamaÃ±o','Ãšnica',40),

(17,'Humo','TamaÃ±o','Ãšnica',40),

(18,'Azul','TamaÃ±o','Ãšnica',100),
...
(26,'Blanco','TamaÃ±o','Ãšnica',120),

(27,'Transparente','TamaÃ±o','Ãšnica',150),
...
(29,'Negro','TamaÃ±o','Ãšnica',8),

(30,'Negro','TamaÃ±o','Ãšnica',5),
...
(33,'Vainilla','PresentaciÃ³n','2lb',30),

(34,'Sin sabor','PresentaciÃ³n','300g',50),

(35,'Negro','Conectividad','Bluetooth',12),

(36,'Azul Rey','TamaÃ±o','L',150),
...
(44,'Blanco','TamaÃ±o','Ãšnica',200);

-- -------------------------------------------------------------------------
-- VARIANTES NUEVAS: 161 variantes para productos IDs 45-104 (60 productos, tallas/colores segÃºn tipo)
-- -------------------------------------------------------------------------
INSERT IGNORE INTO PRODUCTO_VARIANTES (ID_PRODUCTO, COLOR, NOMBRE_ATRIBUTO, ATRIBUTO, STOCK) VALUES
...
-- Producto 79: PantalÃ³n Deportivo (4 tallas x 2 colores = 8 variantes)
(79, 'Negro', 'Talla', 'S', 20),
(79, 'Negro', 'Talla', 'M', 25),
(79, 'Negro', 'Talla', 'L', 30),
...
-- Producto 80: Camiseta CompresiÃ³n (4 tallas x 2 colores = 8 variantes)
(80, 'Negro', 'Talla', 'S', 30),
(80, 'Negro', 'Talla', 'M', 35),
(80, 'Negro', 'Talla', 'L', 40),
...
-- Producto 45: BalÃ³n Training (1 variante)
(45, 'Multicolor', 'Talla', '5', 30),

-- Producto 49: Guantes Portero (1 variante)
(49, 'Negro', 'Talla', 'Ãšnica', 20),

-- Productos 67-70: NataciÃ³n (1 variante cada uno)
(67, 'Amarillo', 'Talla', 'Ãšnica', 25),
(68, 'Verde', 'Talla', 'Ãšnica', 25),
(69, 'Naranja', 'Talla', 'Ãšnica', 25),
(70, 'Azul', 'Talla', 'Ãšnica', 25),

-- Productos 71-74: Cascos ciclismo (1 variante cada uno)
(71, 'Rojo', 'Talla', 'Ãšnica', 15),
(72, 'Azul', 'Talla', 'Ãšnica', 15),
(73, 'Negro', 'Talla', 'Ãšnica', 20),
(74, 'Plata', 'Talla', 'Ãšnica', 20),

-- Productos 75-78: Equipamiento escalada (1 variante cada uno)
(75, 'Rojo', 'Talla', 'Ãšnica', 10),
(76, 'Negro', 'Talla', 'Ãšnica', 10),
(77, 'Amarillo', 'Talla', 'Ãšnica', 10),
(78, 'Blanco', 'Talla', 'Ãšnica', 10),

-- Productos 83-86: Accesorios (1 variante cada uno)
(83, 'Rojo', 'Talla', 'Ãšnica', 50),
(84, 'Azul', 'Talla', 'Ãšnica', 50),
(85, 'Verde', 'Talla', 'Ãšnica', 40),
(86, 'Naranja', 'Talla', 'Ãšnica', 40),

-- Productos 87-90: ProtecciÃ³n (1 variante cada uno)
(87, 'Negro', 'Talla', 'Ãšnica', 30),
(88, 'Azul', 'Talla', 'Ãšnica', 30),
(89, 'Rojo', 'Talla', 'Ãšnica', 25),
(90, 'Verde', 'Talla', 'Ãšnica', 25),

-- Productos 91-93: Cardio (1 variante cada uno)
(91, 'Negro', 'Talla', 'Ãšnica', 15),
(92, 'Plateado', 'Talla', 'Ãšnica', 12),
(93, 'Negro', 'Talla', 'Ãšnica', 15),

-- Productos 94-97: Hogar fitness (1 variante cada uno)
(94, 'Negro', 'Talla', 'Ãšnica', 8),
(95, 'Azul', 'Talla', 'Ãšnica', 8),
(96, 'Rojo', 'Talla', 'Ãšnica', 8),
(97, 'Gris', 'Talla', 'Ãšnica', 8),

-- Productos 98-100: Suplementos (presentaciÃ³n por peso)
(98, 'N/A', 'PresentaciÃ³n', '5lb', 100),
(99, 'N/A', 'PresentaciÃ³n', '300g', 150),
(100, 'N/A', 'PresentaciÃ³n', '300g', 120),

-- Productos 101-102: TecnologÃ­a (1 variante cada uno)
(101, 'Negro', 'Talla', 'Ãšnica', 25),
(102, 'Plateado', 'Talla', 'Ãšnica', 20),

-- Productos 103-104: Ofertas (1 variante cada uno)
(103, 'Rojo', 'Talla', 'Ãšnica', 15),
(104, 'Azul', 'Talla', 'Ãšnica', 12),

-- Producto 46: BalÃ³n de FÃºtbol Premier (balÃ³n reglamentario Talla 5)
(46, 'Blanco', 'TamaÃ±o', 'Talla 5', 30),

-- Producto 50: Medias Antideslizantes FÃºtbol (S/M/L)
(50, 'Negro', 'Talla', 'S', 22),
(50, 'Negro', 'Talla', 'M', 30),
(50, 'Negro', 'Talla', 'L', 18),

-- Producto 51: BalÃ³n Baloncesto Street (Talla 7)
(51, 'Naranja', 'TamaÃ±o', 'Talla 7', 35),

-- Producto 52: BalÃ³n Baloncesto Indoor (Talla 7)
(52, 'MarrÃ³n', 'TamaÃ±o', 'Talla 7', 30),

-- Producto 53: Aro de Baloncesto PortÃ¡til (Ãºnica)
(53, 'Naranja', 'TamaÃ±o', 'Ãšnica', 8),

-- Producto 54: MuÃ±equeras Baloncesto (Ãºnica)
(54, 'Negro', 'TamaÃ±o', 'Ãšnica', 40),
...
-- Producto 63: Banda ElÃ¡stica Resistencia (Ãºnica)
(63, 'Rojo', 'TamaÃ±o', 'Ãšnica', 40),

-- Producto 64: Set Bandas ElÃ¡sticas (set 5 bandas)
(64, 'Multicolor', 'TamaÃ±o', 'Ãšnica', 25),

-- Producto 65: Barra OlÃ­mpica (Ãºnica)
(65, 'Plateado', 'TamaÃ±o', 'Ãšnica', 12),

-- Producto 66: Discos OlÃ­mpicos 10kg (peso 10kg)
(66, 'Negro', 'Peso', '10kg', 30);

-- -------------------------------------------------------------------------
-- IMÃGENES: 3 imÃ¡genes por producto (312 registros = 44Ã—3 + 60Ã—3)
-- -------------------------------------------------------------------------
...
(1,'Ricardo','LÃ³pez','Vendedor','2022-05-01','3021112233','ricardo@tienda.com'),
(2,'Andrea','Reyes','Cajero','2023-02-10','3022223344','andrea@tienda.com'),
(3,'Fernando','MuÃ±oz','Administrador','2021-03-15','3023334455','fernando@tienda.com'),
(4,'Sandra','RamÃ­rez','Contadora','2020-06-20','3024445566','sandra@tienda.com'),
...
(7,'Carlos','MartÃ­nez','Soporte','2022-09-12','3027778899','carlos@tienda.com'),
(8,'Natalia','Ortiz','Vendedor','2024-02-14','3031112233','natalia@tienda.com'),
(9,'Javier','GÃ³mez','LogÃ­stica','2021-11-11','3032223344','javier@tienda.com'),
(10,'Marta','Herrera','Cajero','2023-06-10','3033334455','marta@tienda.com'),
(11,'SebastiÃ¡n','Moreno','Vendedor','2022-03-17','3034445566','sebastian@tienda.com'),
(12,'Paula','Rojas','Cajero','2024-01-09','3035556677','paula@tienda.com');

-- -------------------------------------------------------------------------
-- MÃ‰TODOS DE PAGO: 15 opciones (efectivo, tarjetas, Nequi, PSE, etc.)
-- -------------------------------------------------------------------------
INSERT IGNORE INTO METODOS_PAGO (ID_METODO, NOMBRE_METODO, DESCRIPCION) VALUES
(1,'Efectivo','Pago en dinero fÃ­sico'),
(2,'Tarjeta dÃ©bito','Pago con tarjeta dÃ©bito'),
(3,'Tarjeta crÃ©dito','Pago con tarjeta crÃ©dito'),
(4,'Nequi','Billetera digital'),
(5,'Daviplata','Billetera digital Davivienda'),
(6,'Bancolombia','Transferencia Bancolombia'),
(7,'PSE','Pagos seguros en lÃ­nea'),
(8,'PayPal','Plataforma internacional'),
(9,'Transferencia BBVA','Transferencia bancaria'),
(10,'Contra entrega','Pago al recibir'),
(11,'Apple Pay','Pago mÃ³vil Apple'),
(12,'Google Pay','Pago mÃ³vil Google'),
(13,'CrÃ©dito tienda','FinanciaciÃ³n interna'),
(14,'QR Bancario','Pago por cÃ³digo QR'),
...
-- -------------------------------------------------------------------------
-- RETOS: 16 retos gamificados (sesiones, kilÃ³metros, racha, fuerza, etc.)
-- -------------------------------------------------------------------------
...
(2, 'MaratÃ³n de Km', 'Acumula 15 kilÃ³metros corriendo o caminando', 'km', 15, 8.00, '2026-01-01', '2026-12-31'),
(3, 'Racha Imparable', 'Entrena 7 dÃ­as consecutivos sin saltarte ninguno', 'dias', 7, 10.00, '2026-01-01', '2026-12-31'),
(4, 'Reto Fuerza', 'Completa 10 sesiones de gimnasio o pesas', 'sesiones', 10, 6.00, '2026-01-01', '2026-12-31'),
(5, 'Primer KilÃ³metro', 'Corre o camina tu primer kilÃ³metro del reto', 'km', 1, 3.00, '2026-01-01', '2026-12-31'),
...
(8, 'Medio MaratÃ³n', 'Acumula 21 kilÃ³metros de carrera', 'km', 21, 10.00, '2026-01-01', '2026-12-31'),
(9, 'Semana Sin AzÃºcar', 'Reporta 7 dÃ­as sin consumir azÃºcar aÃ±adida', 'dias', 7, 5.00, '2026-01-01', '2026-12-31'),
(10, 'HidrataciÃ³n Total', 'Registra 14 dÃ­as tomando al menos 2 litros de agua', 'dias', 14, 5.00, '2026-01-01', '2026-12-31'),
(11, 'Ciclismo de Fondo', 'Acumula 50 kilÃ³metros en bicicleta', 'km', 50, 8.00, '2026-01-01', '2026-12-31'),
...
(14, 'Estiramiento Diario', 'Estira 10 dÃ­as seguidos para mejorar movilidad', 'dias', 10, 4.00, '2026-01-01', '2026-12-31'),
(15, '30 Minutos Diarios', 'Entrena 30 minutos al dÃ­a durante 10 dÃ­as', 'dias', 10, 6.00, '2026-01-01', '2026-12-31'),
(16, 'Reto NataciÃ³n', 'Acumula 5 kilÃ³metros de nataciÃ³n', 'km', 5, 8.00, '2026-01-01', '2026-12-31');

-- -------------------------------------------------------------------------
-- PLANTILLAS DE PLANES: 9 planes de entrenamiento (14-21 dÃ­as)
-- -------------------------------------------------------------------------
...
(2, 2, 'Salto y Velocidad', 'Mejora tu salto vertical y rapidez en la cancha', 14, 'Intermedio', '[{\"dia\":1,\"actividad\":\"Saltos a la cuerda 10 min\",\"series\":3},{\"dia\":2,\"actividad\":\"Sentadillas + saltos\",\"series\":4},{\"dia\":3,\"actividad\":\"Descanso\",\"series\":0},{\"dia\":4,\"actividad\":\"Sprints 30m\",\"series\":6},{\"dia\":5,\"actividad\":\"Saltos en cajÃ³n\",\"series\":4},{\"dia\":6,\"actividad\":\"Estocadas con salto\",\"series\":3},{\"dia\":7,\"actividad\":\"Descanso\",\"series\":0}]'),
(3, 4, 'Full Body Principiantes', 'Rutina completa de gimnasio para empezar con buen pie', 14, 'Principiante', '[{\"dia\":1,\"actividad\":\"Press banca + Remo\",\"series\":3},{\"dia\":2,\"actividad\":\"Sentadilla + Peso muerto\",\"series\":3},{\"dia\":3,\"actividad\":\"Descanso\",\"series\":0},{\"dia\":4,\"actividad\":\"Hombros + BÃ­ceps\",\"series\":3},{\"dia\":5,\"actividad\":\"Espalda + TrÃ­ceps\",\"series\":3},{\"dia\":6,\"actividad\":\"Cardio 20 min + abdomen\",\"series\":3},{\"dia\":7,\"actividad\":\"Descanso\",\"series\":0}]'),
(4, 1, 'Resistencia y Agilidad', 'Entrenamiento para futbolistas enfocado en condiciÃ³n fÃ­sica', 14, 'Intermedio', '[{\"dia\":1,\"actividad\":\"Trote continuo 20 min\",\"series\":1},{\"dia\":2,\"actividad\":\"Circuitos de agilidad (conos)\",\"series\":4},{\"dia\":3,\"actividad\":\"Descanso\",\"series\":0},{\"dia\":4,\"actividad\":\"Sprints con cambios de direcciÃ³n\",\"series\":6},{\"dia\":5,\"actividad\":\"Pases y control de balÃ³n\",\"series\":4},{\"dia\":6,\"actividad\":\"Partido reducido 30 min\",\"series\":1},{\"dia\":7,\"actividad\":\"Descanso\",\"series\":0}]'),
(5, 6, 'Fondo de Pierna', 'Plan para ciclistas que buscan aumentar resistencia', 14, 'Intermedio', '[{\"dia\":1,\"actividad\":\"Ruta plana 20 km\",\"series\":1},{\"dia\":2,\"actividad\":\"Series de pedaleo rÃ¡pido\",\"series\":5},{\"dia\":3,\"actividad\":\"Descanso\",\"series\":0},{\"dia\":4,\"actividad\":\"Subidas 10 km\",\"series\":1},{\"dia\":5,\"actividad\":\"Ruta recreativa 30 km\",\"series\":1},{\"dia\":6,\"actividad\":\"Estiramientos + Core\",\"series\":3},{\"dia\":7,\"actividad\":\"Descanso\",\"series\":0}]'),
(6, 5, 'TÃ©cnica y RespiraciÃ³n', 'Plan de nataciÃ³n para mejorar tÃ©cnica y capacidad pulmonar', 14, 'Principiante', '[{\"dia\":1,\"actividad\":\"TÃ©cnica de brazada 200m\",\"series\":4},{\"dia\":2,\"actividad\":\"Ejercicios de respiraciÃ³n\",\"series\":5},{\"dia\":3,\"actividad\":\"Descanso\",\"series\":0},{\"dia\":4,\"actividad\":\"Patada con tabla 300m\",\"series\":3},{\"dia\":5,\"actividad\":\"Estilo libre 500m\",\"series\":1},{\"dia\":6,\"actividad\":\"Combinado 400m\",\"series\":1},{\"dia\":7,\"actividad\":\"Descanso\",\"series\":0}]'),
...
(8, 11, 'Cardio Quema Grasa', 'Plan cardiovascular para mejorar resistencia y quemar calorÃ­as', 14, 'Intermedio', '[{\"dia\":1,\"actividad\":\"Trote 20 min\",\"series\":1},{\"dia\":2,\"actividad\":\"Bicicleta 30 min\",\"series\":1},{\"dia\":3,\"actividad\":\"Descanso\",\"series\":0},{\"dia\":4,\"actividad\":\"HIIT 15 min\",\"series\":1},{\"dia\":5,\"actividad\":\"NataciÃ³n 30 min\",\"series\":1},{\"dia\":6,\"actividad\":\"Caminata rÃ¡pida 40 min\",\"series\":1},{\"dia\":7,\"actividad\":\"Descanso\",\"series\":0}]'),
...
/*
 * setupDatabase â€” FunciÃ³n principal de inicializaciÃ³n.
 *
 * LÃ³gica:
 ...
 *      Las migraciones idempotentes (MIGRACIONES) pueden crear mÃ¡s tablas
 *      sobre bases existentes (DEVOLUCIONES â†’ 33 en total; RETO_EVIDENCIAS,
 ...
 *   Esto resuelve la race condition de Docker donde MySQL aÃºn no acepta
 *   conexiones cuando el backend ya estÃ¡ corriendo.
 *
 * Seguridad: usa una conexiÃ³n temporal (sin pool) que se cierra al finalizar.
 *   No interfiere con el pool de db.js.
 */
/**
 * seedAdminUser: crea/asegura la cuenta de administrador.
 * Se ejecuta en CADA arranque (incluso si las tablas ya existÃ­an),
 * porque sin admin no se puede usar el panel de administraciÃ³n.
...
async function seedAdminUser(connection) {
  ...
  // 1. Si ya existe el admin con ese correo â†’ refresca contraseÃ±a y rol
  ...
  if (target.length > 0) {
    ...
    console.log(`âœ… Setup: Admin (${email}) asegurado con la contraseÃ±a del .env`);
    return;
  }

  // 2. Si existe otro admin con otro correo â†’ lo renombra al correo objetivo
  ...
  if (adminViejo.length > 0) {
    ...
    console.log(`âœ… Setup: Admin existente actualizado â†’ ${email}`);
    return;
  }

  // 3. No hay ningÃºn admin â†’ crea uno nuevo
  ...
  console.log(`âœ… Setup: Usuario administrador creado (${email})`);
  console.log(`   ðŸ” ContraseÃ±a: ${password} â€” cÃ¡mbiala tras el primer ingreso`);
}
 ...
 * esquema, p. ej. COSTO_ENVIO en ENVIOS para el cÃ¡lculo de envÃ­o).
 * Se ejecuta en cada arranque cuando las tablas ya existen; verifica
 * INFORMATION_SCHEMA antes de cada ALTER, asÃ­ que es seguro reiniciar.
 */
const MIGRACIONES = [
  {
    tabla: 'ENVIOS',
    ...
    mensaje: 'columna COSTO_ENVIO agregada a ENVIOS (cÃ¡lculo de envÃ­o)',
  },
  {
    tabla: 'ENVIOS',
    ...
    mensaje: 'columna FECHA_ENTREGA agregada a ENVIOS (plazo de devoluciÃ³n 3 dÃ­as)',
  },
  {
    tabla: 'DESCUENTOS',
    columna: 'USADO',
  ...
  },
  {
    ...
    mensaje: 'tabla AVISOS_STOCK creada (alertas de reposiciÃ³n de stock)',
  },
  {
    tabla: 'DEVOLUCIONES',
    ...
    mensaje: 'tabla DEVOLUCIONES creada (solicitudes de devoluciÃ³n RF-033)',
  },
  {
    tabla: 'DEVOLUCIONES',
    columna: 'DESCRIPCION',
    alterSql: 'ALTER TABLE DEVOLUCIONES ADD COLUMN DESCRIPCION TEXT DEFAULT NULL',
    mensaje: 'columna DESCRIPCION agregada a DEVOLUCIONES (explicaciÃ³n del cliente)',
  },
  {
    tabla: 'DEVOLUCIONES',
    columna: 'TIPO',
  ...
  },
  {
    ...
    mensaje: 'columna MONTO_MINIMO agregada a DESCUENTOS (compra mÃ­nima del cupÃ³n)',
  },
  {
    tabla: 'CHAT',
    columna: 'PARTE',
  ...
  },
  {
    ...
    mensaje: 'columnas ULTIMA_CONEXION/ULTIMA_IP/ULTIMA_UBICACION agregadas a USUARIOS (Ãºltima conexiÃ³n)',
  },
  {
  ...
  },
  {
    ...
    mensaje: 'columna DEBE_CAMBIAR_PASSWORD agregada a USUARIOS (contraseÃ±a temporal de vendedor)',
  },
  {
  ...
  },
  {
    ...
    mensaje: 'columna ID_VENDEDOR agregada a PRODUCTOS (artÃ­culos publicados por vendedores)',
  },
  {
    tabla: 'PRODUCTOS',
    ...
    mensaje: 'columna ESTADO_PUBLICACION agregada a PRODUCTOS (aprobaciÃ³n de artÃ­culos de vendedores)',
  },
];
...
async function migrarTablasExistentes(connection) {
  for (const migracion of MIGRACIONES) {
    ...
    if (columnas.length === 0) {
      ...
      console.log(`âš™ï¸  Setup: MigraciÃ³n aplicada â€” ${migracion.mensaje}`);
    }
  }
  await connection.query(RETOS_ADICIONALES);
  console.log('âš™ï¸  Setup: Retos adicionales asegurados (INSERT IGNORE).');
  ...
  console.log('âš™ï¸  Setup: Rol Vendedor (ID 6) asegurado.');

  // Vincula artÃ­culos a los vendedores aprobados segÃºn sus categorÃ­as (demo).
  // Idempotente: solo procesa vendedores que aÃºn NO tienen ningÃºn producto
  // (el vendedor puede publicar/despublicar despuÃ©s en su panel).
  const normTexto = (s) =>
    String(s || '')
      .toLowerCase()
      .normalize('NFD')
  ...
  if (vendedoresSinProductos.length > 0) {
    ...
    for (const ven of vendedoresSinProductos) {
      ...
      if (productos.length > 0) {
        console.log(
          `âš™ï¸  Setup: ${productos.length} artÃ­culos vinculados al vendedor #${ven.ID_VENDEDOR} (categorÃ­as: ${ven.CATEGORIAS})`
        );
      }
    }
  }

  // Ãndice Ãºnico en CATEGORIAS.NOMBRE_CATEGORIA (RF-027): evita duplicados
  // por carrera de peticiones (check-then-insert sin UNIQUE). Idempotente:
  // consulta INFORMATION_SCHEMA.STATISTICS antes de crear el Ã­ndice.
  ...
  if (Number(stats[0].total) === 0) {
    try {
      ...
      console.log("âš™ï¸  Setup: MigraciÃ³n aplicada â€” Ã­ndice Ãºnico uq_categoria_nombre en CATEGORIAS (RF-027)");
    } catch (err) {
      console.error(
        "âš ï¸  Setup: No se pudo crear el Ã­ndice Ãºnico en CATEGORIAS (Â¿existen duplicados?):",
        err.message
      );
    }
  }

  // MigraciÃ³n: URLs externas â†’ locales en PRODUCTO_IMAGENES + elimina producto 45 duplicado
  await migrarImagenesALocales(connection);

  // SOLICITUDES_VENDEDOR.ID_USUARIO nullable: el formulario "Ser vendedor" ya no exige
  // iniciar sesiÃ³n (la solicitud se asocia al correo de la empresa; al aprobar se crea
  ...
  if (solCol.length > 0 && solCol[0].IS_NULLABLE === 'NO') {
    try {
      ...
      console.log("âš™ï¸  Setup: MigraciÃ³n aplicada â€” ID_USUARIO nullable en SOLICITUDES_VENDEDOR (solicitud sin iniciar sesiÃ³n)");
    } catch (err) {
      console.error('âš ï¸  Setup: No se pudo hacer nullable ID_USUARIO en SOLICITUDES_VENDEDOR:', err.message);
    }
  }
  ...
  for (const [tabla, col] of [
    ...
    if (colInfo.length > 0 && colInfo[0].IS_NULLABLE === 'NO') {
      try {
        ...
        console.log(`âš™ï¸  Setup: MigraciÃ³n aplicada â€” ${col} nullable en ${tabla} (vendedor informal)`);
      } catch (err) {
        console.error(`âš ï¸  Setup: No se pudo hacer nullable ${col} en ${tabla}:`, err.message);
      }
    }
  }
  ...
  for (const col of ['RUTA', 'RUTAS_EXTRA']) {
    ...
    if (evCol.length > 0 && evCol[0].IS_NULLABLE === 'NO') {
      try {
        ...
        console.log(`âš™ï¸  Setup: MigraciÃ³n aplicada â€” ${col} nullable en RETO_EVIDENCIAS`);
      } catch (err) {
        console.error(`âš ï¸  Setup: No se pudo hacer nullable ${col} en RETO_EVIDENCIAS:`, err.message);
      }
    }
  }
}
...
async function migrarImagenesALocales(connection) {
  ...
  console.log("âš™ï¸  Setup: Migrando URLs de imÃ¡genes a rutas locales...");
  ...
  if (!fs.existsSync(uploadsDir)) {
    console.warn("âš ï¸  Setup: /app/uploads no existe, omitiendo migraciÃ³n de imÃ¡genes");
    return;
  }
  ...
  console.log(`⚙️  Setup: Migración imágenes completada — ${actualizadas} URLs actualizadas`);
}

/**
 * CONTENIDOS_PRODUCTO: semilla inicial de descripciones profesionales +
 * caracterÃ­sticas curadas (mÃ³dulo backend/database/contenidos-producto.js).
 * La BD es la fuente de verdad: este mÃ³dulo solo se aplica donde hace falta
 * (descripciÃ³n vacÃ­a o aÃºn la corta del seed; caracterÃ­sticas que falten),
 * de modo que las ediciones realizadas desde el panel admin PERSISTEN.
 * Para re-sembrar TODO el catÃ¡logo manualmente, definir FORCE_CONTENIDOS=1
 * en el .env del backend (restaura el contenido del mÃ³dulo).
 */
const CONTENIDOS_PRODUCTO = require('./contenidos-producto');

/** Aplica los contenidos de producto (descripciones + caracterÃ­sticas) de forma
 *  NO destructiva: solo actualiza productos cuya descripciÃ³n sigue siendo un
 *  texto gestionado (el corto del seed o una versiÃ³n anterior del mÃ³dulo) y
 *  nunca pisa ediciones hechas desde el panel admin. Al actualizar una
 *  descripciÃ³n se REEMPLAZA su ficha tÃ©cnica vieja; en arranques normales solo
 *  se agregan caracterÃ­sticas faltantes. Con FORCE_CONTENIDOS=1 reescribe todo. */
async function asegurarContenidosProducto(connection) {
  ...
  for (const p of CONTENIDOS_PRODUCTO) {
    ...
    // original admite string o array de textos legados que el mÃ³dulo puede actualizar
    ...
    if (cambioDesc) {
      ...
      descActualizadas++;
      // Mejora de versiÃ³n: sustituye la ficha tÃ©cnica vieja por la curada
      ...
      // Arranque normal: solo agrega las caracterÃ­sticas que falten
      for (const c of p.caracteristicas || []) {
  ...
  if (descActualizadas > 0 || caracReemplazadas > 0 || caracInsertadas > 0) {
    console.log(`âœ… Setup: Contenido de productos sembrado${forzar ? ' (forzado)' : ''} â€” ${descActualizadas} descripciones actualizadas, ${caracReemplazadas} caracterÃ­sticas reemplazadas, ${caracInsertadas} agregadas`);
  }
}
...
async function setupDatabase() {
  ...
  for (let attempt = 1; attempt <= maxRetries; attempt++) {
    try {
      ...
      if (tables.length > 0) {
        console.log(`âš™ï¸  Setup: Tablas ya existen, omitiendo creaciÃ³n y seed.`);
      ...
      console.log(`âš™ï¸  Setup: Tablas y datos de referencia...`);
      await connection.query(CREATE_TABLES_RAW);
      await connection.query(SEED_DATA);
      await asegurarContenidosProducto(connection);
      await seedAdminUser(connection);

      console.log(`âœ… Setup: Base de datos '${DB_NAME}' lista (tablas + datos de referencia)`);
      return;
    } catch (err) {
      if (attempt === maxRetries) {
        console.error(`âŒ Setup: Error definitivo - ${err.message}`);
        return;
      }
      console.log(`âš ï¸  Setup: MySQL no listo (intento ${attempt}/${maxRetries})...`);
