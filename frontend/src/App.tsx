...
function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  // Lista de rutas donde NO queremos mostrar el Navbar ni el Carrito
  ...
  return (
    <>
      {/* Navbar solo se muestra si NO estamos en una ruta de autenticación */}
      {!esPaginaAuth && <Navbar />}
      
      {/* Contenido de la página actual */}
      {children}
      
      {/* Elementos flotantes del carrito solo se muestran en rutas principales */}
      {!esPaginaAuth && (
        <>
          <FloatingCart />
          <MiniCartMenu />
