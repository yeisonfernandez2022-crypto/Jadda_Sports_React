...
* **Historia:** Como usuario nuevo, **quiero** crear una cuenta proporcionando mi nombre, correo electrónico y contraseña, **para** poder acceder a las funcionalidades del sistema NN Auth.
